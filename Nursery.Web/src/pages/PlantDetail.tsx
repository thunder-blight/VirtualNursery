      ...
      <div className="detail-card">
        ...
        {confirmDelete && (
          <div className="confirm-delete">
            <p>Delete <strong>{plant.name}</strong> from the catalog? This affects all users.</p>
            <div className="confirm-actions">
              <button className="save-button" onClick={handleDelete} disabled={deleting}>
                {deleting ? "Deleting..." : "Yes, delete"}
              </button>
              <button className="cancel-button" onClick={() => setConfirmDelete(false)} disabled={deleting}>
                Cancel
              </button>
            </div>
          </div>
